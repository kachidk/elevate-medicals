...
import { ArrowBack, Home, ExpandLess, ExpandMore, Accessible, Remove } from "@material-ui/icons";
import TodayIcon from '@material-ui/icons/Today';


function NurseSidebar({ sidebarOpen, setSidebarOpen }) {
      ...
      >
        ...
        <div>
          ...
          >
            {/* home */}
            <ListItem button>
              <InertiaLink href="/nurseDashboard" className="flex items-center w-full">
            ...
            {/* patient menu */}
            <ListItem button onClick={()=>setPatientDropdown(!patientDropdown)}>
              <Accessible className={classes.listIcons}/>
              <ListItemText primary="Patients" />
              {patientDropdown ? <ExpandLess /> : <ExpandMore />}
            </ListItem>
            <Collapse in={patientDropdown} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {/* add patient */}
                <ListItem button className={classes.nested}>
                  <InertiaLink href="/nurseAddPatient" className="flex items-center w-full">
                ...
                {/* view patient */}
                <ListItem button className={classes.nested}>
                  <InertiaLink href="/nurseViewPatient" className="flex items-center w-full">
                    <Remove className={classes.listIcons}/>
