...
function CompletedTodayAppointment() {
  ...
  function fetchCompletedData(pageNumber = 1) {
    axios
      .get("nurseTodayCompletedAppointment", {
        params: {
          page: pageNumber,
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-2">
        <div>
          <h1 className="font-bold text-md">Today's Completed Appointments</h1>
        </div>
        <TextField
          label="Search"
          id="patientId"
          ...
          helperText={
            searchState.length < 4 && searchState != ""
