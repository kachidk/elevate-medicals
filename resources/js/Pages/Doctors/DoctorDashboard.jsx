...
function DoctorDashboard() {
  ...
  function fetchOngoingData(pageNumber = 1) {
    axios
      .get("doctorTodayOngoingAppointment", {
        params: {
          page: pageNumber,
    ...
    <div>
      <DoctorLayout>
        <div className="header">
          <div className="header-text">Doctor Dashboard</div>
        </div>

        <div className="grid gap-6 mx-auto mb-8 md:grid-cols-2 xl:grid-cols-2 w-max">
          {/* <!-- Card --> */}
          <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div className="p-3 mr-4 text-red-500 bg-red-100 rounded-full dark:text-blue-100 dark:bg-blue-500">
              <Today />
            </div>
            <div>
