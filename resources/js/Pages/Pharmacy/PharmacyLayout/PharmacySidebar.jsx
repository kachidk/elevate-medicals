...
function PharmacySidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    <div className="lg:w-64">
      ...
      >
        ...
        <div className="flex justify-between pr-3 mb-10 sm:px-2">
          {/* Logo */}
          <InertiaLink href="/pharmacyDashboard" className="block">
        ...
        <div>
          ...
          >
            {/* home */}
            <ListItem button>
              <InertiaLink href="/pharmacyDashboard" className="flex items-center w-full">
